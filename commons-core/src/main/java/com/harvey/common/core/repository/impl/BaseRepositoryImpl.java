package com.harvey.common.core.repository.impl;
...
import com.harvey.common.core.repository.BaseRepository;

public abstract class BaseRepositoryImpl<TModel extends BaseModel, TKey extends Serializable> implements BaseRepository<TModel, TKey> {

    private final Log log = LogFactory.getLog(getClass());
    private final Class<TModel> modelClass;
    private final Class<TKey> keyClass;

    public BaseRepositoryImpl(Class<TModel> modelClass, Class<TKey> keyClass) {
